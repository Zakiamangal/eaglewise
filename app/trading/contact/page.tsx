          ...
          <div className="container-shell">
            ...
            >
              ...
              <motion.h2 variants={fadeInUp} className="text-3xl font-bold tracking-tight text-foreground md:text-4xl">
                Trading, sourcing, and partnership inquiries
              </motion.h2>
              <motion.p variants={fadeInUp} className="mt-4 max-w-3xl text-base leading-relaxed text-muted-foreground md:text-lg">
                For business inquiries, distribution partnerships, and product sourcing discussions, share your details and our team will respond.
              </motion.p>
            </motion.div>
              ...
              <div className="flex flex-col gap-6">
                ...
                >
                  <Image
                    ...
                    alt="Eaglewise trading operations"
                    width={800}
                    height={400}
