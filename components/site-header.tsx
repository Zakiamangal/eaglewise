            ...
            if (menuItems.length > 0) {
              return (
                <div key={item.href} className="group relative py-2">
                  ...
                  <div className={`nav-dropdown-${accent} pointer-events-none absolute left-1/2 top-full z-50 w-[560px] -translate-x-1/2 translate-y-2 bg-white/90 p-6 opacity-0 backdrop-blur-xl transition-all duration-300 ease-out group-hover:pointer-events-auto group-hover:translate-y-0 group-hover:opacity-100 group-focus-within:pointer-events-auto group-focus-within:translate-y-0 group-focus-within:opacity-100`}>
